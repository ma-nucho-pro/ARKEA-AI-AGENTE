...
from backend.arkea_core.agent_runtime import agent_request_context
...
def _handle_message_impl(message: str, project_id: int | None = None, skill_id: str | None = None, mode: str = "auto", conversation_id: int | None = None):
...
def handle_message(message: str, project_id: int | None = None, skill_id: str | None = None,
                   mode: str = "auto", conversation_id: int | None = None):
    with agent_request_context(skill_id):
        return _handle_message_impl(message, project_id, skill_id, mode, conversation_id)
