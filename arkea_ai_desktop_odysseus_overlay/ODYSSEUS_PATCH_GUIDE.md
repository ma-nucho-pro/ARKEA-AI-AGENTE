...
O usa `scripts\start_windows.bat` para el modo standalone exclusivamente de
desarrollo en loopback. Ese script desactiva de forma explícita la
autenticación local; no lo expongas a la red ni lo uses como despliegue.
